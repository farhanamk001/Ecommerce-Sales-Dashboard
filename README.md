...
This project is a Power BI Ecommerce Sales Dashboard created for a US-based ecommerce company.
The goal of this dashboard is to analyze Year-To-Date (YTD) sales performance, track key business KPIs, and generate actionable insights using Power BI, Power Query, and DAX.

The dashboard helps stakeholders understand sales trends, profitability, customer performance, and regional insights in a visually interactive way.
